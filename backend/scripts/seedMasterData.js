...
const BRANDS_DATA = [
  {
    name: "Nike",
    slug: "nike",
    desc: "Thương hiệu thể thao hàng đầu thế giới với phong cách hiện đại và hiệu suất đỉnh cao.",
  },
  {
    name: "adidas",
    slug: "adidas",
    desc: "Biểu tượng thời trang thể thao Đức với thiết kế 3 sọc kinh điển và công nghệ đột phá.",
  },
  {
    name: "Levi's",
    slug: "levis",
    desc: "Thương hiệu trang phục denim kinh điển của Mỹ, nổi tiếng thế giới từ năm 1853.",
  },
  {
    name: "UNIQLO",
    slug: "uniqlo",
    desc: "Thương hiệu thời trang tối giản LifeWear Nhật Bản với chất lượng cao và sự thoải mái.",
  },
  {
    name: "ZARA",
    slug: "zara",
    desc: "Thương hiệu thời trang nhanh Tây Ban Nha dẫn đầu xu hướng thời trang quốc tế.",
  },
  {
    name: "H&M",
    slug: "hm",
    desc: "Thời trang Thụy Điển đa dạng phong cách, thân thiện và phong phú cho mọi lứa tuổi.",
  },
  {
    name: "New Balance",
    slug: "new-balance",
    desc: "Thương hiệu giày chạy và lifestyle phong cách retro cổ điển đến từ Mỹ.",
  },
  {
    name: "PUMA",
    slug: "puma",
    desc: "Thời trang thể thao cá tính và năng động với biểu tượng con báo nhảy kiêu hãnh.",
  },
];
...
const CATEGORIES_DATA = [
  {
    name: "Áo thun",
    slug: "ao-thun",
    desc: "Bộ sưu tập áo thun nam nữ cotton, phông cơ bản và thể thao thoáng mát.",
  },
  {
    name: "Áo sơ mi",
    slug: "ao-so-mi",
    desc: "Áo sơ mi công sở, sơ mi đơ mi phong cách thanh lịch và hiện đại.",
  },
  {
    name: "Áo khoác & Blazer",
    slug: "ao-khoac-blazer",
    desc: "Áo khoác gió, khoác dù, blazer thời trang ấm áp và đẳng cấp.",
  },
  {
    name: "Hoodie & Sweatshirt",
    slug: "hoodie-sweatshirt",
    desc: "Áo nỉ có mũ và không mũ streetwear trẻ trung, năng động.",
  },
  {
    name: "Quần Jeans",
    slug: "quan-jeans",
    desc: "Quần bò denim nam nữ dáng ôm, dáng suông, dáng nguyên bản.",
  },
  {
    name: "Quần tây & Kaki",
    slug: "quan-tay-kaki",
    desc: "Quần kaki, quần âu công sở sang trọng và thoải mái vận động.",
  },
  {
    name: "Đầm & Váy",
    slug: "dam-vay",
    desc: "Bộ sưu tập đầm nữ, váy midi, váy xòe duyên dáng thời thượng.",
  },
  {
    name: "Giày Sneaker",
    slug: "giay-sneaker",
    desc: "Giày thể thao, giày phong cách streetwear chính hãng êm ái.",
  },
  {
    name: "Túi xách & Ba lô",
    slug: "tui-xach-ba-lo",
    desc: "Túi đeo chéo, túi xách nữ, ba lô du lịch và học tập cá tính.",
  },
  {
    name: "Phụ kiện",
    slug: "phu-kien",
    desc: "Mũ nón, thắt lưng, vớ tất và phụ kiện thời trang hoàn thiện outfit.",
  },
];
...
const REAL_IMAGE_POOL = {
  "giay-sneaker": {
    ...
    trang:
      "https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&w=900&h=1200&q=85",
    "xanh-navy":
      "https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?auto=format&fit=crop&w=900&h=1200&q=85",
    ...
    khaki:
      "https://images.unsplash.com/photo-1584735935682-2f2b69dff9d2?auto=format&fit=crop&w=900&h=1200&q=85",
    "xanh-la":
      "https://images.unsplash.com/photo-1608256246200-53e635b5b65f?auto=format&fit=crop&w=900&h=1200&q=85",
  },
  "quan-jeans": {
    den: "https://images.unsplash.com/photo-1541099649105-f69ad21f3246?auto=format&fit=crop&w=900&h=1200&q=85",
    trang:
      "https://images.unsplash.com/photo-1582552938357-32b906df40cb?auto=format&fit=crop&w=900&h=1200&q=85",
    "xanh-navy":
      "https://images.unsplash.com/photo-1542272604-787c3835535d?auto=format&fit=crop&w=900&h=1200&q=85",
    ...
    khaki:
      "https://images.unsplash.com/photo-1565084888279-aca607ecce0c?auto=format&fit=crop&w=900&h=1200&q=85",
    "xanh-la":
      "https://images.unsplash.com/photo-1541099649105-f69ad21f3246?auto=format&fit=crop&w=900&h=1200&q=85",
  },
  "ao-thun": {
    den: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=900&h=1200&q=85",
    trang:
      "https://images.unsplash.com/photo-1503341504253-dff4815485f1?auto=format&fit=crop&w=900&h=1200&q=85",
    "xanh-navy":
      "https://images.unsplash.com/photo-1583743814966-8936f37f4f7d?auto=format&fit=crop&w=900&h=1200&q=85",
    ...
    khaki:
      "https://images.unsplash.com/photo-1576995853123-5a10305d93c0?auto=format&fit=crop&w=900&h=1200&q=85",
    "xanh-la":
      "https://images.unsplash.com/photo-1618354691373-d851c5c3a990?auto=format&fit=crop&w=900&h=1200&q=85",
  },
  "dam-vay": {
    den: "https://images.unsplash.com/photo-1595777457583-95e059d581b8?auto=format&fit=crop&w=900&h=1200&q=85",
    trang:
      "https://images.unsplash.com/photo-1566174053879-31528523f8ae?auto=format&fit=crop&w=900&h=1200&q=85",
    "xanh-navy":
      "https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?auto=format&fit=crop&w=900&h=1200&q=85",
    ...
    khaki:
      "https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?auto=format&fit=crop&w=900&h=1200&q=85",
    "xanh-la":
      "https://images.unsplash.com/photo-1496747611176-843222e1e57c?auto=format&fit=crop&w=900&h=1200&q=85",
  },
  "tui-xach-ba-lo": {
    den: "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?auto=format&fit=crop&w=900&h=1200&q=85",
    trang:
      "https://images.unsplash.com/photo-1584917865442-de89df76afd3?auto=format&fit=crop&w=900&h=1200&q=85",
    "xanh-navy":
      "https://images.unsplash.com/photo-1594223274512-ad4803739b7c?auto=format&fit=crop&w=900&h=1200&q=85",
    ...
    khaki:
      "https://images.unsplash.com/photo-1590874103328-eac38a683ce7?auto=format&fit=crop&w=900&h=1200&q=85",
    "xanh-la":
      "https://images.unsplash.com/photo-1577733966973-d680bffd2e80?auto=format&fit=crop&w=900&h=1200&q=85",
  },
};
...
const MASTER_PRODUCT_TEMPLATES = [
  ...
  {
    name: "Giày Nike Pegasus 40 Running",
    brand: "nike",
    category: "giay-sneaker",
    price: 3590000,
    code: "PEG40",
  ...
  {
    name: "Áo Hoodie Nike Club Fleece",
    brand: "nike",
  ...
  {
    name: "Áo Thun Nike Dri-FIT Fitness",
    brand: "nike",
    category: "ao-thun",
    price: 890000,
    code: "NK-DRIFIT",
  ...
  {
    name: "Áo Khoác Nike Windrunner Jacket",
    brand: "nike",
    category: "ao-khoac-blazer",
    price: 2290000,
    code: "NK-WIND",
  },
  {
    name: "Quần Jogger Nike Sportswear Club",
    brand: "nike",
    category: "quan-tay-kaki",
    price: 1390000,
    code: "NK-JOG",
  },
  {
    name: "Ba Lô Nike Heritage Backpack",
    brand: "nike",
    category: "tui-xach-ba-lo",
    price: 850000,
    code: "NK-BP",
  },
  {
    name: "Mũ Lưỡi Trai Nike Club Cap",
    brand: "nike",
    category: "phu-kien",
    price: 550000,
    code: "NK-CAP",
  ...
  {
    name: "Áo Sơ Mi Nike Sportswear Tech",
    brand: "nike",
    category: "ao-so-mi",
    price: 1490000,
    code: "NK-SHIRT",
  ...
  {
    name: "Quần Shorts Nike Flex Woven",
    brand: "nike",
    category: "quan-tay-kaki",
    price: 990000,
    code: "NK-SHORT",
  ...
  {
    name: "Túi Đeo Chéo Nike Heritage Crossbody",
    brand: "nike",
    category: "tui-xach-ba-lo",
    price: 690000,
    code: "NK-CROSS",
  ...
  // 2. adidas Products
  {
    name: "Giày adidas Samba OG Classic",
    brand: "adidas",
    category: "giay-sneaker",
    price: 2790000,
    code: "AD-SAMBA",
  ...
  {
    name: "Giày adidas Stan Smith Primegreen",
    brand: "adidas",
    category: "giay-sneaker",
    price: 2390000,
    code: "AD-STAN",
  ...
  {
    name: "Áo Khoác Track Jacket Firebird",
    brand: "adidas",
    category: "ao-khoac-blazer",
    price: 1990000,
    code: "AD-FIRE",
  ...
  {
    name: "Áo Thun adidas 3-Stripes Essentials",
    brand: "adidas",
    category: "ao-thun",
    price: 790000,
    code: "AD-TEE",
  ...
  {
    name: "Áo Hoodie adidas Originals Trefoil",
    brand: "adidas",
    category: "hoodie-sweatshirt",
    price: 1690000,
    code: "AD-HOOD",
  ...
  {
    name: "Quần Track Pants adidas Adicolor",
    brand: "adidas",
    category: "quan-tay-kaki",
    price: 1590000,
    code: "AD-PANTS",
  ...
  {
    name: "Túi Đeo Vai adidas Originals Mini",
    brand: "adidas",
    category: "tui-xach-ba-lo",
    price: 750000,
    code: "AD-BAG",
  ...
  {
    name: "Mũ Bucket adidas Trefoil Cap",
    brand: "adidas",
    category: "phu-kien",
    price: 490000,
    code: "AD-BUCKET",
  ...
  {
    name: "Áo Sơ Mi adidas Resort Short Sleeve",
    brand: "adidas",
    category: "ao-so-mi",
    price: 1390000,
    code: "AD-SHIRT",
  ...
  // 3. Levi's Products
  {
    name: "Quần Jeans Levi's 501 Original Fit",
    brand: "levis",
    category: "quan-jeans",
    price: 2290000,
    code: "LV-501",
  ...
  {
    name: "Quần Jeans Levi's 511 Slim Fit",
    brand: "levis",
    category: "quan-jeans",
    price: 2090000,
    code: "LV-511",
  ...
  {
    name: "Quần Jeans Levi's 505 Regular Fit",
    brand: "levis",
    category: "quan-jeans",
    price: 1990000,
    code: "LV-505",
  ...
  {
    name: "Áo Khoác Denim Levi's Trucker Jacket",
    brand: "levis",
    category: "ao-khoac-blazer",
    price: 2690000,
    code: "LV-TRUCK",
  ...
  {
    name: "Áo Thun Levi's Housemark Logo Tee",
    brand: "levis",
    category: "ao-thun",
    price: 590000,
    code: "LV-TEE",
  ...
  {
    name: "Áo Sơ Mi Denim Levi's Western Shirt",
    brand: "levis",
    category: "ao-so-mi",
    price: 1490000,
    code: "LV-WEST",
  ...
  {
    name: "Thắt Lưng Levi's Leather Belt Classic",
    brand: "levis",
    category: "phu-kien",
    price: 890000,
    code: "LV-BELT",
  ...
  {
    name: "Áo Hoodie Levi's Graphic Standard",
    brand: "levis",
    category: "hoodie-sweatshirt",
    price: 1390000,
    code: "LV-HOOD",
  ...
  {
    name: "Quần Jeans Levi's Ribcage Straight Leg",
    brand: "levis",
    category: "quan-jeans",
    price: 2390000,
    code: "LV-RIBCAGE",
  ...
  {
    name: "Váy Denim Levi's Iconic Skirt",
    brand: "levis",
    category: "dam-vay",
    price: 1290000,
    code: "LV-SKIRT",
  ...
  {
    name: "Túi Tote Levi's Cotton Canvas",
    brand: "levis",
    category: "tui-xach-ba-lo",
    price: 490000,
    code: "LV-TOTE",
  ...
  // 4. UNIQLO Products
  {
    name: "Áo Thun UNIQLO AIRism Oversized",
    brand: "uniqlo",
    category: "ao-thun",
    price: 399000,
    code: "UQ-AIRISM",
  ...
  {
    name: "Áo Thun UNIQLO Supima Cotton Tee",
    brand: "uniqlo",
    category: "ao-thun",
    price: 299000,
    code: "UQ-SUPIMA",
  ...
  {
    name: "Áo Sơ Mi UNIQLO Oxford Long Sleeve",
    brand: "uniqlo",
    category: "ao-so-mi",
    price: 599000,
    code: "UQ-OXFORD",
  ...
  {
    name: "Áo Sơ Mi Linen UNIQLO Premium",
    brand: "uniqlo",
    category: "ao-so-mi",
    price: 799000,
    code: "UQ-LINEN",
  ...
  {
    name: "Quần Smart Ankle Pants UNIQLO",
    brand: "uniqlo",
    category: "quan-tay-kaki",
    price: 799000,
    code: "UQ-ANKLE",
  ...
  {
    name: "Quần Kaki UNIQLO Vintage Chino",
    brand: "uniqlo",
    category: "quan-tay-kaki",
    price: 699000,
    code: "UQ-CHINO",
  ...
  {
    name: "Áo Phao UNIQLO Ultra Light Down",
    brand: "uniqlo",
    category: "ao-khoac-blazer",
    price: 1690000,
    code: "UQ-ULD",
  ...
  {
    name: "Túi Đeo Bán Nguyệt UNIQLO Round Shoulder",
    brand: "uniqlo",
    category: "tui-xach-ba-lo",
    price: 399000,
    code: "UQ-BAG",
  ...
  {
    name: "Đầm UNIQLO Mercerized Cotton Midi",
    brand: "uniqlo",
    category: "dam-vay",
    price: 799000,
    code: "UQ-DRESS",
  ...
  {
    name: "Áo Sweatshirt UNIQLO Dry-EX",
    brand: "uniqlo",
    category: "hoodie-sweatshirt",
    price: 599000,
    code: "UQ-SWEAT",
  ...
  {
    name: "Quần Jeans UNIQLO Stretch Slim Fit",
    brand: "uniqlo",
    category: "quan-jeans",
    price: 999000,
    code: "UQ-JEANS",
  ...
  // 5. ZARA Products
  {
    name: "Áo Blazer ZARA Tailored Oversized",
    brand: "zara",
    category: "ao-khoac-blazer",
    price: 1990000,
    code: "ZR-BLAZER",
  ...
  {
    name: "Đầm Midi ZARA Satin Slip Dress",
    brand: "zara",
    category: "dam-vay",
    price: 1390000,
    code: "ZR-SATIN",
  ...
  {
    name: "Áo Sơ Mi ZARA Poplin Oversized",
    brand: "zara",
    category: "ao-so-mi",
    price: 999000,
    code: "ZR-SHIRT",
  ...
  {
    name: "Quần Tây ZARA High-Waisted Wide Leg",
    brand: "zara",
    category: "quan-tay-kaki",
    price: 1190000,
    code: "ZR-PANTS",
  ...
  {
    name: "Áo Thun ZARA Essential Ribbed Tee",
    brand: "zara",
    category: "ao-thun",
    price: 399000,
    code: "ZR-TEE",
  ...
  {
    name: "Áo Khoác Da ZARA Faux Leather Jacket",
    brand: "zara",
    category: "ao-khoac-blazer",
    price: 2490000,
    code: "ZR-LEATHER",
  ...
  {
    name: "Túi Xách ZARA Shoulder Bag Gold Chain",
    brand: "zara",
    category: "tui-xach-ba-lo",
    price: 1290000,
    code: "ZR-BAG",
  ...
  {
    name: "Đầm Ngắn ZARA Linen Cut-Out Dress",
    brand: "zara",
    category: "dam-vay",
    price: 1190000,
    code: "ZR-DRESS",
  ...
  {
    name: "Quần Jeans ZARA Straight High Rise",
    brand: "zara",
    category: "quan-jeans",
    price: 1290000,
    code: "ZR-JEANS",
  ...
  {
    name: "Áo Hoodie ZARA Heavyweight Wash",
    brand: "zara",
    category: "hoodie-sweatshirt",
    price: 1190000,
    code: "ZR-HOOD",
  ...
  // 6. H&M Products
  {
    name: "Áo Thun H&M Regular Fit Cotton",
    brand: "hm",
    category: "ao-thun",
    price: 249000,
    code: "HM-TEE",
  ...
  {
    name: "Áo Sơ Mi H&M Linen-Blend Shirt",
    brand: "hm",
    category: "ao-so-mi",
    price: 599000,
    code: "HM-LINEN",
  ...
  {
    name: "Đầm H&M Floral Printed Viscose",
    brand: "hm",
    category: "dam-vay",
    price: 699000,
    code: "HM-FLORAL",
  ...
  {
    name: "Áo Hoodie H&M Relaxed Fit",
    brand: "hm",
    category: "hoodie-sweatshirt",
    price: 699000,
    code: "HM-HOOD",
  ...
  {
    name: "Quần Jogger H&M Sweatpants Cotton",
    brand: "hm",
    category: "quan-tay-kaki",
    price: 499000,
    code: "HM-JOG",
  ...
  {
    name: "Áo Khoác Cardigan H&M Knitwear",
    brand: "hm",
    category: "ao-khoac-blazer",
    price: 799000,
    code: "HM-CARD",
  ...
  {
    name: "Quần Jeans H&M Loose Straight Fit",
    brand: "hm",
    category: "quan-jeans",
    price: 899000,
    code: "HM-JEANS",
  ...
  {
    name: "Túi Crossbody H&M Canvas Mini",
    brand: "hm",
    category: "tui-xach-ba-lo",
    price: 349000,
    code: "HM-BAG",
  ...
  {
    name: "Đầm H&M Ribbed Bodycon Dress",
    brand: "hm",
    category: "dam-vay",
    price: 499000,
    code: "HM-BODY",
  ...
  {
    name: "Mũ Beanie H&M Fine-Knit Hat",
    brand: "hm",
    category: "phu-kien",
    price: 199000,
    code: "HM-HAT",
  ...
  {
    name: "Giày New Balance 574 Core Classic",
    brand: "new-balance",
    category: "giay-sneaker",
    price: 2490000,
    code: "NB-574",
  ...
  {
    name: "Giày New Balance 530 Lifestyle",
    brand: "new-balance",
    category: "giay-sneaker",
    price: 2790000,
    code: "NB-530",
  ...
  {
    name: "Giày New Balance 2002R Protection",
    brand: "new-balance",
    category: "giay-sneaker",
    price: 3890000,
    code: "NB-2002R",
  ...
  {
    name: "Giày New Balance 9060 Unisex",
    brand: "new-balance",
    category: "giay-sneaker",
    price: 3990000,
    code: "NB-9060",
  ...
  {
    name: "Áo Thun New Balance Athletics Tee",
    brand: "new-balance",
    category: "ao-thun",
    price: 750000,
    code: "NB-TEE",
  ...
  {
    name: "Áo Hoodie New Balance Classic Stacked",
    brand: "new-balance",
    category: "hoodie-sweatshirt",
    price: 1490000,
    code: "NB-HOOD",
  ...
  {
    name: "Quần Shorts New Balance Athletics",
    brand: "new-balance",
    category: "quan-tay-kaki",
    price: 890000,
    code: "NB-SHORT",
  ...
  {
    name: "Mũ Lưỡi Trai New Balance Curved Cap",
    brand: "new-balance",
    category: "phu-kien",
    price: 450000,
    code: "NB-CAP",
  ...
  {
    name: "Ba Lô New Balance Team Backpack",
    brand: "new-balance",
    category: "tui-xach-ba-lo",
    price: 890000,
    code: "NB-BP",
  ...
  {
    name: "Áo Khoác Windcheater New Balance",
    brand: "new-balance",
    category: "ao-khoac-blazer",
    price: 1890000,
    code: "NB-JACKET",
  ...
  // 8. PUMA Products
  {
    name: "Giày PUMA Suede Classic XXI",
    brand: "puma",
    category: "giay-sneaker",
    price: 1990000,
    code: "PM-SUEDE",
  ...
  {
    name: "Giày PUMA Palermo OG Leather",
    brand: "puma",
    category: "giay-sneaker",
    price: 2390000,
    code: "PM-PALERMO",
  ...
  {
    name: "Áo T7 Track Jacket PUMA Iconic",
    brand: "puma",
    category: "ao-khoac-blazer",
    price: 1690000,
    code: "PM-T7",
  ...
  {
    name: "Áo Thun PUMA Essentials Logo Tee",
    brand: "puma",
    category: "ao-thun",
    price: 590000,
    code: "PM-TEE",
  ...
  {
    name: "Áo Hoodie PUMA Classic Fleece",
    brand: "puma",
    category: "hoodie-sweatshirt",
    price: 1390000,
    code: "PM-HOOD",
  ...
  {
    name: "Ba Lô PUMA Phase Backpack",
    brand: "puma",
    category: "tui-xach-ba-lo",
    price: 690000,
    code: "PM-BP",
  ...
  {
    name: "Mũ PUMA Classic Baseball Cap",
    brand: "puma",
    category: "phu-kien",
    price: 390000,
    code: "PM-CAP",
  ...
  {
    name: "Túi Đeo Chéo PUMA Portable Bag",
    brand: "puma",
    category: "tui-xach-ba-lo",
    price: 490000,
    code: "PM-CROSS",
...
async function seedMasterData() {
  ...
  try {
    ...
    for (let i = 0; i < 2; i++) {
      for (const t of MASTER_PRODUCT_TEMPLATES) {
        ...
        const suffix =
          i === 0
            ? ""
            : ` (${PRODUCT_SUFFIXES[productIndex % PRODUCT_SUFFIXES.length]})`;
        rawTemplates.push({
          ...t,
          name: t.name + suffix,
    ...
    for (let i = 0; i < rawTemplates.length; i++) {
      ...
      const availableSizes = CATEGORY_SIZES[template.category] || [
        "S",
        "M",
        "L",
        "XL",
      ...
      const poolForCat =
        REAL_IMAGE_POOL[template.category] || REAL_IMAGE_POOL["ao-thun"];
      ...
      selectedColors.forEach((color, cIdx) => {
        availableSizes.forEach((size, sIdx) => {
          const colorAttrVal = colorAttribute.values.find(
            (v) => v.slug === color.slug,
          );
          const sizeAttrVal = sizeAttribute.values.find(
            (v) => v.slug === slugify(size),
          );
      ...
      const parentSalePrice = hasProductDiscount
        ? Math.round(template.price * 0.88)
        : null;
        ...
        option_axes: [
          {
            ...
            attribute_name: colorAttribute.name,
            attribute_slug: colorAttribute.slug,
            value_ids: selectedColors.map(
              (c) => colorAttribute.values.find((v) => v.slug === c.slug)._id,
            ),
          },
          {
            attribute_id: sizeAttribute._id,
            attribute_name: sizeAttribute.name,
            attribute_slug: sizeAttribute.slug,
            value_ids: availableSizes.map(
              (s) =>
                sizeAttribute.values.find((v) => v.slug === slugify(s))._id,
            ),
          },
        ],
        variants,
    ...
    const totalVariantsCount = insertedProducts.reduce(
      (sum, p) => sum + p.variants.length,
      0,
    );
    console.log(
      `✅ Đã tạo thành công ${insertedProducts.length} sản phẩm và ${totalVariantsCount} biến thể.`,
    );
    ...
    console.log(
      `✅ Đã tạo thành công ${insertedUsers.length} tài khoản người dùng.`,
    );

    // Step F: Seed ~250 Orders & Status Timelines over the past 6 months
    console.log(
      "📜 Đang tạo ~250 Đơn hàng rải đều 6 tháng và Timeline lịch sử...",
    );
    ...
    for (let i = 1; i <= 260; i++) {
      ...
      for (let j = 0; j < orderItemCount; j++) {
        ...
        const colorImgAsset = prod.image_assets.find(
          (a) => String(a._id) === String(variant.image_asset_ids[0]),
        );
        const imageUrl = colorImgAsset
          ? colorImgAsset.url
          : prod.images[0] || "";
      ...
      if (status === "completed") {
        for (const item of orderItems) {
          ...
          reviewDocsToInsert.push({
            ...
            createdAt: new Date(
              orderDate.getTime() + (75 + Math.random() * 48) * 3600 * 1000,
            ),
          });
        }
      }
    ...
    if (paymentTxnToInsert.length > 0) {
      ...
      console.log(
        `✅ Đã tạo thành công ${paymentTxnToInsert.length} giao dịch thanh toán.`,
      );
    }
    ...
    console.log(
      `✅ Đã tạo thành công ${insertedReviews.length} đánh giá sản phẩm.`,
    );
    ...
    console.log(
      "❤️ Đang tạo Danh sách yêu thích (Wishlist) cho 30 khách hàng...",
    );
    const wishlistDocsToInsert = [];
    for (let i = 0; i < 30; i++) {
      const customer = customerUsers[i];
      const sampledProds = getRandomSample(
        insertedProducts,
        getRandomInt(2, 5),
      );
    ...
    console.log(
      `✅ Đã tạo thành công ${wishlistDocsToInsert.length} sản phẩm trong danh sách yêu thích.`,
    );
